...
@BindingAdapter("listaCiudad")
fun bindRecyclerViewCiudad(recyclerView: RecyclerView, data: List<CiudadModel>?) {
    val adapter = recyclerView.adapter as AgregarUbicacionAdapter
    adapter.submitList(data)
}
